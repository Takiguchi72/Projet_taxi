...
public class ProjetTaxi {
	...
	public static Double calculerTotal( int departement, int periode, int distance ) throws Exception
	{
		...
		// département et de la période saisis
		double[] tarifsUtilises = GestionBdd.obtenirTarifs( departement, periode );
	...
	public static void main( String[] args ) {
		...
		// Note : Pour je ne sais quelle raison, la JVM ne calcule pas
		// correctement et me sortait des nombre à 6-7 décimales.
		// J'ai donc réalisé une petite méthode arrondissant le total à payer.
		try {
			System.out.println( "\nVoici le montant à payer : " +
					arrondirAuCentime( calculerTotal( departement, periode, distance ) ) +
					" €" );
		} catch ( Exception ex ) {
